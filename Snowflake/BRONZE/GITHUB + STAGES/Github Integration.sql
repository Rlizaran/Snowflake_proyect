...
CREATE OR REPLACE API INTEGRATION github_api_integration
  ...
  ALLOWED_AUTHENTICATION_SECRETS = (DB_CITYBIKE_BRONZE.CITYBIKE.GITHUB_PAT)
  ENABLED = TRUE;

-- GIT REPOSITORY apuntando al repo de GitHub
CREATE OR REPLACE GIT REPOSITORY DB_CITYBIKE_BRONZE.CITYBIKE.CITIBIKE_REPO
  API_INTEGRATION = github_api_integration
  GIT_CREDENTIALS = DB_CITYBIKE_BRONZE.CITYBIKE.GITHUB_PAT
  ORIGIN = 'https://github.com/Rlizaran/Snowflake_proyect.git';

-- Verificaciones
SHOW GIT BRANCHES IN DB_CITYBIKE_BRONZE.CITYBIKE.CITIBIKE_REPO;
LS @DB_CITYBIKE_BRONZE.CITYBIKE.CITIBIKE_REPO/branches/main/;
