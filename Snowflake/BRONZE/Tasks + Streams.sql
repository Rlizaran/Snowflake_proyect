...
CREATE OR REPLACE TASK LOGS.TSK_BRONZE_NOAA
    ...
    WHEN SYSTEM$STREAM_HAS_DATA('DB_CITYBIKE_BRONZE.LOGS.STM_CITIBIKE_NY')
        OR SYSTEM$STREAM_HAS_DATA('DB_CITYBIKE_BRONZE.LOGS.STM_CITIBIKE_JC')
...
CREATE OR REPLACE TASK LOGS.TSK_BRONZE_JC_ONFILES
    ...
    WHEN SYSTEM$STREAM_HAS_DATA('DB_CITYBIKE_BRONZE.LOGS.STM_CITIBIKE_JC')
