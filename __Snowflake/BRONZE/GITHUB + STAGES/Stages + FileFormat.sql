...
CREATE OR REPLACE STAGE DB_CITYBIKE_BRONZE.CITYBIKE.CITYBIKE_S3_STAGE
    URL = 's3://tripdata'
...
CREATE OR REPLACE STAGE DB_CITYBIKE_BRONZE.CITYBIKE.CITYBIKE_LANDING_STAGE
...
CREATE OR REPLACE STAGE DB_CITYBIKE_BRONZE.NOAA.NOAA_S3_STAGE_STATION
...
CREATE OR REPLACE STAGE DB_CITYBIKE_BRONZE.NOAA.NOAA_S3_STAGE_YEAR
