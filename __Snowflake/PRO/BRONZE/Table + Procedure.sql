...
BEGIN
    ...
    PATTERN = '(202[4-5][0-9]{2}|2026[0-3])-citibike-tripdata\\.zip'
    ON_ERROR = 'CONTINUE';
...
BEGIN
    ...
    VALUES ('LOAD_CITYBIKE_NY_INT_PRO', 'OK', 'rows=' || :v_rows || ' files=' || :v_files);
...
EXCEPTION
    WHEN OTHER THEN
        INSERT INTO DB_CITYBIKE_LOGS.LOGS.LOAD_LOG (task_name, outcome, details)
        VALUES ('LOAD_CITYBIKE_NY_INT_PRO', 'ERROR', :SQLERRM);
        RAISE;
